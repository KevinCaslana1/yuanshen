...
| EXP-Q2-015 | Arithmetic versus harmonic face mean | real Q2 0–10800 s；`n=80`；`dt=.25 s`；plus manufactured benchmark | real-run max difference `1.36852384e-6 K` / `4.94771902e-7 kg/kg`；benchmark preserves expected conservation/order；arithmetic is the lower-cost recommendation, pending human freeze | PASS as comparison；OQ-FVM-001 OPEN | `experiments/EXP-Q2-015-INTERFACE-MEAN/` |
