...
## Q3/Q4 Final-Freeze Boundary

Q3/Q4 已完成人工 final freeze，`t3`、`t4` 和时间差可从最终 manifest、审计文档及冻结表格追溯取数；本文件仍未自动登记新的论文 `VERIFIED` 主张。时间差只报告为数值差异，不单独写成模型优越性、物理真实性或最终比赛结论；Q3→Q4 同时改变几何和附录物性。
